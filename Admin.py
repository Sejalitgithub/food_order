...
class admin:
    def __init__(self,root):
      ...
      ############ BTN ##################
        ...
        ####### BUTTON ############
        viewbtn = Button(btn_frame, text="VIEW PRODUCT",command=self.ViewBtn,width=22, font=("times new roman",14,"bold"), bg="black", fg="gold", bd=0,cursor="hand1")
        viewbtn.grid(row=0, column=0,pady=1)

        newbtn = Button(btn_frame, text="ADD PRODUCT",command=self.AddFoodBtn, width=22, font=("times new roman",14,"bold"), bg="black", fg="gold", bd=0,cursor="hand1")
        newbtn.grid(row=1, column=0,pady=1)
        reportbtn = Button(btn_frame, text="REPORT",width=22,font=("times new roman",14,"bold"), bg="black", fg="gold", bd=0,cursor="hand1")
        reportbtn.grid(row=2 ,column=0,pady=1)

        userbtn = Button(btn_frame, text="USER ACCOUNT",width=22, font=("times new roman",14,"bold"), bg="black", fg="gold", bd=0,cursor="hand1")
        userbtn.grid(row=3, column=0,pady=1)
    ...
    def ViewBtn(self):
        ...
        self.app = addpro(self.new_window)


    def AddFoodBtn(self):
      self.new_window = Toplevel(self.root)
      self.app = addfood(self.new_window)
